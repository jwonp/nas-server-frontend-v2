  ...
  return (
    <article className="flex py-10">
      <div className="mx-auto">
        <div className="flex max-login:block">
          <div className="flex">
            <div className="max-login:mx-auto">
              <div className="flex">
                <p className="leading-7 text-xl text-center">우측 상단의</p>
                ...
                <p className="leading-7 text-xl">를</p>
              </div>
            </div>
          </div>
          <p className="leading-7 text-xl text-center">
            클릭해서 폴더 및 파일를 추가해주세요.
          </p>
        </div>
      </div>
    </article>
