...
| ![[lambda.png \| 80x80]] | ![AWS API Gateway \| 80x80](https://noticon-static.tammolo.com/dgggcrkxq/image/upload/v1694089639/noticon/ox4ngdartf1uzusjhcqx.png) | ![Firebase \| 80x80](https://noticon-static.tammolo.com/dgggcrkxq/image/upload/v1566913958/noticon/uoqjdixts4lwsgtsa1pd.png) |
| ---- | ---- | ---- |
| AWS Lambda | AWS API Gateway | Firebase |

## 배포

| ![[ec2.png \| 80x80]]| ![Nginx \| 80x80](https://noticon-static.tammolo.com/dgggcrkxq/image/upload/v1566798146/noticon/lku5cppzh8r7awwsmmko.png) |![pm2\|80x80](pm2.png)|
|--------|--------|--------|
|AWS EC2|Nginx|pm2|
...
##### 문제해결
 ...
 ![[파일선택.png|example-wide]] ![[메인.png|example-wide]]
...
![[Nas Server/화면/로그인.png|example]]![[Nas Server/화면/회원가입.png|example]]![[Nas server v2/UI/로그인.png|example]]![[Nas server v2/UI/회원가입.png|example]]
